...
export default function ItemConfigManage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (editId) await itemConfigApi.update(editId, body)
      else await itemConfigApi.create(body)
      setFormOpen(false); toast.success(editId ? '薪资项更新成功' : '薪资项创建成功'); void loadData()
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <Modal open={formOpen} onClose={() => setFormOpen(false)} title={editId ? '编辑薪资项' : '新建薪资项'}>
